...
/**
 * @typedef {Object|ConsoleChannelSettings} ChannelSettings
...
/**
 * @typedef {Object} ConsoleChannelSettings
 * @property {string} [eol=os.EOL] - the end of line character to be used.
 * @property {ConsoleOutput} [output='STDOUT'] - the destination output in the console.
 */

/**
 * @typedef {('STDOUT'|'STDERR')} ConsoleOutput
 */
