...
export function toCamelCase () {
  let string = filter.call(arguments, (argument) => argument && typeof argument === 'string')
 ...
 */
export function guard (error, conditional, message) {
    ...
    if (source != null && source !== target) {
      for (key in source) {
        if (typeof source[ key ] === 'object') {
          if (!hasOwnProperty.call(target, key) || typeof target[ key ] === 'object') {
